...
DECLARE MAP QUERY11_mNATION1_E2_3[][P_PARTKEY:int, QUERY11_mNATIONNATION_NATIONKEY:int] := 
AggSum([P_PARTKEY:int, QUERY11_mNATIONNATION_NATIONKEY:int], 
  (PARTSUPP(PS_PARTKEY:int, PS_SUPPKEY:int, PS_AVAILQTY:int,
              PS_SUPPLYCOST:float, PS_COMMENT:string) *
    (P_PARTKEY:int ^= PS_PARTKEY:int) *
    SUPPLIER(PS_SUPPKEY:int, S_NAME:string, S_ADDRESS:string,
               QUERY11_mNATIONNATION_NATIONKEY:int, S_PHONE:string,
               S_ACCTBAL:float, S_COMMENT:string) *
    PS_SUPPLYCOST:float * PS_AVAILQTY:int));

DECLARE MAP QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
[QUERY11_mNATIONNATION_NATIONKEY:int,
   QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int] := 
AggSum([QUERY11_mNATIONNATION_NATIONKEY:int,
          QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int], 
  SUPPLIER(QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int,
             S_NAME:string, S_ADDRESS:string,
             QUERY11_mNATIONNATION_NATIONKEY:int, S_PHONE:string,
             S_ACCTBAL:float, S_COMMENT:string));

DECLARE MAP QUERY11_mNATION7_L1_4[][QUERY11_mNATIONNATION_NATIONKEY:int] := 
AggSum([QUERY11_mNATIONNATION_NATIONKEY:int], 
  (PARTSUPP(PS_PARTKEY:int, PS_SUPPKEY:int, PS_AVAILQTY:int,
              PS_SUPPLYCOST:float, PS_COMMENT:string) *
    SUPPLIER(PS_SUPPKEY:int, S_NAME:string, S_ADDRESS:string,
...
ON + SUPPLIER(SUPPLIER_SUPPKEY:int, SUPPLIER_NAME:string, SUPPLIER_ADDRESS:string, SUPPLIER_NATIONKEY:int, SUPPLIER_PHONE:string, SUPPLIER_ACCTBAL:float, SUPPLIER_COMMENT:string) {
   QUERY11(float)[][P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  ((EXISTS(
     ...
     (EXISTS( QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
       AggSum([], 
         ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
           ...
           {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) *
    -1));
   QUERY11_mNATION1_E2_3(float)[][P_PARTKEY:int, SUPPLIER_NATIONKEY:int] += QUERY11_mSUPPLIER1_E2_3[][P_PARTKEY:int, SUPPLIER_SUPPKEY:int];
   QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[][SUPPLIER_NATIONKEY:int, SUPPLIER_SUPPKEY:int] += 1;
   QUERY11_mNATION7_L1_4(float)[][SUPPLIER_NATIONKEY:int] += QUERY11_mSUPPLIER7_L1_4[][SUPPLIER_SUPPKEY:int];
     ...
     (EXISTS( QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
       AggSum([], 
         ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
           ...
           {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) *
    -1));
   QUERY11_mNATION1_E2_3(float)[][P_PARTKEY:int, SUPPLIER_NATIONKEY:int] += (QUERY11_mSUPPLIER1_E2_3[][P_PARTKEY:int, SUPPLIER_SUPPKEY:int] * -1);
   QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[][SUPPLIER_NATIONKEY:int, SUPPLIER_SUPPKEY:int] += -1;
   QUERY11_mNATION7_L1_4(float)[][SUPPLIER_NATIONKEY:int] += (QUERY11_mSUPPLIER7_L1_4[][SUPPLIER_SUPPKEY:int] * -1);
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  (QUERY11_mSUPPLIER1_E2_2(int)[][SUPPLIER_NATIONKEY:int] *
     ...
     (EXISTS( QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
       AggSum([], 
         ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
           ...
           {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) *
    -1));
   QUERY11_mNATION1_E2_3(float)[][PARTSUPP_PARTKEY:int, QUERY11_mNATIONNATION_NATIONKEY:int] += 
  (QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
 [QUERY11_mNATIONNATION_NATIONKEY:int, PARTSUPP_SUPPKEY:int] *
  PARTSUPP_SUPPLYCOST:float * PARTSUPP_AVAILQTY:int);
   QUERY11_mNATION7_L1_4(float)[][QUERY11_mNATIONNATION_NATIONKEY:int] += 
  (QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
 [QUERY11_mNATIONNATION_NATIONKEY:int, PARTSUPP_SUPPKEY:int] *
  PARTSUPP_SUPPLYCOST:float * PARTSUPP_AVAILQTY:int);
...
ON - PARTSUPP(PARTSUPP_PARTKEY:int, PARTSUPP_SUPPKEY:int, PARTSUPP_AVAILQTY:int, PARTSUPP_SUPPLYCOST:float, PARTSUPP_COMMENT:string) {
  ...
  (((EXISTS(
   ...
   QUERY11_mNATION1_E2_3(float)[][PARTSUPP_PARTKEY:int, QUERY11_mNATIONNATION_NATIONKEY:int] += 
  (QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
 [QUERY11_mNATIONNATION_NATIONKEY:int, PARTSUPP_SUPPKEY:int] * -1 *
  PARTSUPP_SUPPLYCOST:float * PARTSUPP_AVAILQTY:int);
   QUERY11_mNATION7_L1_4(float)[][QUERY11_mNATIONNATION_NATIONKEY:int] += 
  (QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
 [QUERY11_mNATIONNATION_NATIONKEY:int, PARTSUPP_SUPPKEY:int] * -1 *
...
ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
  ...
  ((EXISTS(
    (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
      ({NATION_NAME:string = 'GERMANY'} *
        QUERY11_mNATION1_E2_3[][P_PARTKEY:int, NATION_NATIONKEY:int]))) *
   (AggSum([], 
      ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
        (P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
        {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)) +
     ...
     AggSum([], 
       ((__sql_inline_agg_1:float ^=
          ((QUERY11_mPARTSUPP1_L1_1[][] +
             ({NATION_NAME:string = 'GERMANY'} *
               QUERY11_mNATION7_L1_4[][NATION_NATIONKEY:int])) *
            0.001)) *
         (P_VALUE:float ^=
           (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
             ({NATION_NAME:string = 'GERMANY'} *
        ...
        AggSum([], 
          ((__sql_inline_agg_1:float ^=
            ...
            (P_VALUE:float ^=
              (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
                ({NATION_NAME:string = 'GERMANY'} *
                  QUERY11_mNATION1_E2_3[]
                  [P_PARTKEY:int, NATION_NATIONKEY:int]))) *
            {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) +
     (EXISTS( QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
       AggSum([], 
         ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
           ...
           {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) *
    -1));
   QUERY11_mSUPPLIER1_E2_2(int)[][NATION_NATIONKEY:int] += {NATION_NAME:string = 'GERMANY'};
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION7_L1_4[][NATION_NATIONKEY:int]);
   QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION1_E2_3[][P_PARTKEY:int, NATION_NATIONKEY:int]);
   QUERY11_mPARTSUPP1_E2_3(int)[][QUERY11_mPARTSUPPPARTSUPP_SUPPKEY:int] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
  [NATION_NATIONKEY:int, QUERY11_mPARTSUPPPARTSUPP_SUPPKEY:int]);
}
   ...
   (AggSum([], 
     ...
     AggSum([], 
       ((__sql_inline_agg_1:float ^=
          ((QUERY11_mPARTSUPP1_L1_1[][] * 0.001) +
            ({NATION_NAME:string = 'GERMANY'} *
              QUERY11_mNATION7_L1_4[][NATION_NATIONKEY:int] * -0.001))) *
         (P_VALUE:float ^=
           (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
             ({NATION_NAME:string = 'GERMANY'} *
               QUERY11_mNATION1_E2_3[][P_PARTKEY:int, NATION_NATIONKEY:int] *
          ...
          ((__sql_inline_agg_1:float ^=
            ...
            (P_VALUE:float ^=
              (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
                ({NATION_NAME:string = 'GERMANY'} *
                  QUERY11_mNATION1_E2_3[]
                  [P_PARTKEY:int, NATION_NATIONKEY:int] * -1))) *
            {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) +
     (EXISTS( QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int]) *
       AggSum([], 
         ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
           ...
           {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))) *
    -1));
   QUERY11_mSUPPLIER1_E2_2(int)[][NATION_NATIONKEY:int] += ({NATION_NAME:string = 'GERMANY'} * -1);
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION7_L1_4[][NATION_NATIONKEY:int] * -1);
   QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION1_E2_3[][P_PARTKEY:int, NATION_NATIONKEY:int] * -1);
   QUERY11_mPARTSUPP1_E2_3(int)[][QUERY11_mPARTSUPPPARTSUPP_SUPPKEY:int] += 
  ({NATION_NAME:string = 'GERMANY'} *
  QUERY11_mNATION1_E2_3_mPARTSUPP1(int)[]
  [NATION_NATIONKEY:int, QUERY11_mPARTSUPPPARTSUPP_SUPPKEY:int] * -1);
}
...
CORRECT QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] += delta_QUERY11_mPARTSUPP1_E2_1:float FOR ON + SUPPLIER(SUPPLIER_SUPPKEY:int, SUPPLIER_NAME:string, SUPPLIER_ADDRESS:string, SUPPLIER_NATIONKEY:int, SUPPLIER_PHONE:string, SUPPLIER_ACCTBAL:float, SUPPLIER_COMMENT:string) {
   QUERY11(float)[][delta_P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  (((EXISTS(
        ...
        ((__sql_inline_agg_1:float ^=
          ...
          ((P_VALUE:float ^=
            ...
            ((P_VALUE:float ^=
              ...
              -1)) *
          {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)))));
   QUERY11_mNATION1_E2_3(float)[][delta_P_PARTKEY:int, SUPPLIER_NATIONKEY:int] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} *
  delta_QUERY11_mSUPPLIER1_E2_3:float);
    ...
    ((P_VALUE:float ^=
      ...
      ((__sql_inline_agg_1:float ^=
        ...
        ((__sql_inline_agg_1:float ^=
          ...
          -1)) *
      {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)));
   QUERY11_mNATION7_L1_4(float)[][SUPPLIER_NATIONKEY:int] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} *
  delta_QUERY11_mSUPPLIER7_L1_4:float);
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} *
...
CORRECT QUERY11_mSUPPLIER1_E2_3[][delta_P_PARTKEY:int,delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int] += delta_QUERY11_mSUPPLIER1_E2_3:float FOR ON - SUPPLIER(SUPPLIER_SUPPKEY:int, SUPPLIER_NAME:string, SUPPLIER_ADDRESS:string, SUPPLIER_NATIONKEY:int, SUPPLIER_PHONE:string, SUPPLIER_ACCTBAL:float, SUPPLIER_COMMENT:string) {
  ...
  ((EXISTS(
   ...
   QUERY11_mNATION1_E2_3(float)[][delta_P_PARTKEY:int, SUPPLIER_NATIONKEY:int] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} * 
-1 * delta_QUERY11_mSUPPLIER1_E2_3:float);
   QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} *
...
CORRECT QUERY11_mSUPPLIER7_L1_4[][delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int] += delta_QUERY11_mSUPPLIER7_L1_4:float FOR ON - SUPPLIER(SUPPLIER_SUPPKEY:int, SUPPLIER_NAME:string, SUPPLIER_ADDRESS:string, SUPPLIER_NATIONKEY:int, SUPPLIER_PHONE:string, SUPPLIER_ACCTBAL:float, SUPPLIER_COMMENT:string) {
  ...
  AggSum([], 
   ...
   QUERY11_mNATION7_L1_4(float)[][SUPPLIER_NATIONKEY:int] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} * 
-1 * delta_QUERY11_mSUPPLIER7_L1_4:float);
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({SUPPLIER_SUPPKEY:int = delta_QUERY11_mSUPPLIERSUPPLIER_SUPPKEY:int} *
  QUERY11_mSUPPLIER1_E2_2(int)[][SUPPLIER_NATIONKEY:int] * -1 *
  delta_QUERY11_mSUPPLIER7_L1_4:float);
...
CORRECT QUERY11_mNATION1_E2_3_mPARTSUPP1[][delta_QUERY11_mNATIONNATION_NATIONKEY:int,delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int] += delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int FOR ON + PARTSUPP(PARTSUPP_PARTKEY:int, PARTSUPP_SUPPKEY:int, PARTSUPP_AVAILQTY:int, PARTSUPP_SUPPLYCOST:float, PARTSUPP_COMMENT:string) {
   QUERY11_mNATION1_E2_3(float)[][PARTSUPP_PARTKEY:int, delta_QUERY11_mNATIONNATION_NATIONKEY:int] += 
  ({PARTSUPP_SUPPKEY:int =
 delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int} *
  delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int * PARTSUPP_SUPPLYCOST:float *
  PARTSUPP_AVAILQTY:int);
   QUERY11_mNATION7_L1_4(float)[][delta_QUERY11_mNATIONNATION_NATIONKEY:int] += 
  ({PARTSUPP_SUPPKEY:int =
 delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int} *
  delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int * PARTSUPP_SUPPLYCOST:float *
  PARTSUPP_AVAILQTY:int);
...
CORRECT QUERY11_mNATION1_E2_3_mPARTSUPP1[][delta_QUERY11_mNATIONNATION_NATIONKEY:int,delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int] += delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int FOR ON - PARTSUPP(PARTSUPP_PARTKEY:int, PARTSUPP_SUPPKEY:int, PARTSUPP_AVAILQTY:int, PARTSUPP_SUPPLYCOST:float, PARTSUPP_COMMENT:string) {
   QUERY11_mNATION1_E2_3(float)[][PARTSUPP_PARTKEY:int, delta_QUERY11_mNATIONNATION_NATIONKEY:int] += 
  ({PARTSUPP_SUPPKEY:int =
 delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int} * -1 *
  delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int * PARTSUPP_SUPPLYCOST:float *
  PARTSUPP_AVAILQTY:int);
   QUERY11_mNATION7_L1_4(float)[][delta_QUERY11_mNATIONNATION_NATIONKEY:int] += 
  ({PARTSUPP_SUPPKEY:int =
...
CORRECT QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] += delta_QUERY11_mPARTSUPP1_E2_1:float FOR ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
   QUERY11(float)[][delta_P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  (((EXISTS(
     (QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] +
       ({NATION_NAME:string = 'GERMANY'} *
         QUERY11_mNATION1_E2_3[][delta_P_PARTKEY:int, NATION_NATIONKEY:int]) +
       delta_QUERY11_mPARTSUPP1_E2_1:float)) +
    (EXISTS(
       (QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] +
         ({NATION_NAME:string = 'GERMANY'} *
       ...
       ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
         (P_VALUE:float ^=
           (QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] +
             ({NATION_NAME:string = 'GERMANY'} *
               QUERY11_mNATION1_E2_3[]
               [delta_P_PARTKEY:int, NATION_NATIONKEY:int]))) *
         {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)) +
     AggSum([], 
       ((__sql_inline_agg_1:float ^=
          ((QUERY11_mPARTSUPP1_L1_1[][] +
...
CORRECT QUERY11_mNATION1_E2_3[][delta_P_PARTKEY:int,delta_QUERY11_mNATIONNATION_NATIONKEY:int] += delta_QUERY11_mNATION1_E2_3:float FOR ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
   QUERY11(float)[][delta_P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  (((NATION_NATIONKEY:int ^= delta_QUERY11_mNATIONNATION_NATIONKEY:int) *
   (((EXISTS(
        (({NATION_NAME:string = 'GERMANY'} *
           (QUERY11_mNATION1_E2_3[]
            [delta_P_PARTKEY:int, NATION_NATIONKEY:int] +
             delta_QUERY11_mNATION1_E2_3:float)) +
          QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int])) +
       (EXISTS(
          (QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] +
            ({NATION_NAME:string = 'GERMANY'} *
     ...
     ((((EXISTS(
        ...
        ((EXISTS(
           ...
           ((NATION_NATIONKEY:int ^=
              delta_QUERY11_mNATIONNATION_NATIONKEY:int) *
             (EXISTS(
                (({NATION_NAME:string = 'GERMANY'} *
                   (QUERY11_mNATION1_E2_3[]
                    [delta_P_PARTKEY:int, NATION_NATIONKEY:int] +
  ...
  ((EXISTS(
   ...
   QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int] += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  {NATION_NAME:string = 'GERMANY'} * delta_QUERY11_mNATION1_E2_3:float);
}

CORRECT QUERY11_mPARTSUPP1_L1_1[][] += delta_QUERY11_mPARTSUPP1_L1_1:float FOR ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
   QUERY11(float)[][P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  ((EXISTS(
    (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
      ({NATION_NAME:string = 'GERMANY'} *
...
CORRECT QUERY11_mNATION7_L1_4[][delta_QUERY11_mNATIONNATION_NATIONKEY:int] += delta_QUERY11_mNATION7_L1_4:float FOR ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
   QUERY11(float)[][P_PARTKEY:int]:((Exists(QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * AggSum([],(((P_VALUE:float ^= QUERY11_mPARTSUPP1_E2_1(float)[][P_PARTKEY:int]) * (__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1(float)[][] * 0.001)) * {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float))))) += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  EXISTS(
    (QUERY11_mPARTSUPP1_E2_1[][P_PARTKEY:int] +
  ...
  AggSum([], 
    ((P_VALUE:float ^=
      ...
      ((__sql_inline_agg_1:float ^=
         ((({NATION_NAME:string = 'GERMANY'} *
             (QUERY11_mNATION7_L1_4[][NATION_NATIONKEY:int] +
               delta_QUERY11_mNATION7_L1_4:float)) +
            QUERY11_mPARTSUPP1_L1_1[][]) *
           0.001)) +
        ((__sql_inline_agg_1:float ^=
           ((QUERY11_mPARTSUPP1_L1_1[][] +
   ...
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  {NATION_NAME:string = 'GERMANY'} * delta_QUERY11_mNATION7_L1_4:float);
}
...
CORRECT QUERY11_mNATION1_E2_3_mPARTSUPP1[][delta_QUERY11_mNATIONNATION_NATIONKEY:int,delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int] += delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int FOR ON + NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
   QUERY11_mPARTSUPP1_E2_3(int)[][delta_QUERY11_mNATION1_E2_3_mPARTSUPPPARTSUPP_SUPPKEY:int] += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  {NATION_NAME:string = 'GERMANY'} *
  delta_QUERY11_mNATION1_E2_3_mPARTSUPP1:int);
}
       ...
       ((__sql_inline_agg_1:float ^= (QUERY11_mPARTSUPP1_L1_1[][] * 0.001)) *
         (P_VALUE:float ^=
           (QUERY11_mPARTSUPP1_E2_1[][delta_P_PARTKEY:int] +
             ({NATION_NAME:string = 'GERMANY'} *
               QUERY11_mNATION1_E2_3[]
               [delta_P_PARTKEY:int, NATION_NATIONKEY:int] * -1))) *
         {P_VALUE:float > __sql_inline_agg_1:float} * P_VALUE:float)) +
     AggSum([], 
       ((__sql_inline_agg_1:float ^=
          ((QUERY11_mPARTSUPP1_L1_1[][] * 0.001) +
...
CORRECT QUERY11_mNATION1_E2_3[][delta_P_PARTKEY:int,delta_QUERY11_mNATIONNATION_NATIONKEY:int] += delta_QUERY11_mNATION1_E2_3:float FOR ON - NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
  ...
  ((EXISTS(
   ...
   QUERY11_mPARTSUPP1_E2_1(float)[][delta_P_PARTKEY:int] += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  {NATION_NAME:string = 'GERMANY'} * -1 * delta_QUERY11_mNATION1_E2_3:float);
}
...
CORRECT QUERY11_mNATION7_L1_4[][delta_QUERY11_mNATIONNATION_NATIONKEY:int] += delta_QUERY11_mNATION7_L1_4:float FOR ON - NATION(NATION_NATIONKEY:int, NATION_NAME:string, NATION_REGIONKEY:int, NATION_COMMENT:string) {
  ...
  AggSum([], 
   ...
   QUERY11_mPARTSUPP1_L1_1(float)[][] += 
  ({NATION_NATIONKEY:int = delta_QUERY11_mNATIONNATION_NATIONKEY:int} *
  {NATION_NAME:string = 'GERMANY'} * -1 * delta_QUERY11_mNATION7_L1_4:float);
}
