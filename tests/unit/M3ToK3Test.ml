    ...
    group "Replace" [
      ...
      test_stmt "OutPC-Singleton" ["A","1.0";"B","1.0"] 
          ...
          ("{|(1.0,1.0,12.0);(1.0,2.0,2.0);(2.0,1.0,2.0);(2.0,2.0,4.0);"^
             "(1.0,3.0,3.0)|}");
      test_stmt "OutPC-Singleton" ["A","3.0";"B","3.0"] 
          "R[][A,B] := {12.}" 
          "R" 
          ("{|(1.0,1.0,1.0);(1.0,2.0,2.0);(2.0,1.0,2.0);(2.0,2.0,4.0);"^
             "(1.0,3.0,3.0);(3.0,3.0,12.0)|}");
      test_stmt "OutPC-Slice1" ["A","1.0"] 
          "R[][A,B] := (B ^= 1.) * {12.}" 
          "R" 
          ("{|(1.0,1.0,12.0);(2.0,1.0,2.0);(2.0,2.0,4.0)|}");
      test_stmt "OutPC-Slice2" ["A","1.0"] 
          "R[][A,B] := ((B ^= 1.) * {12.}) + ((B ^= 2.) * {3.})" 
          "R" 
          ("{|(1.0,1.0,12.0);(1.0,2.0,3.0);(2.0,1.0,2.0);(2.0,2.0,4.0)|}");
      test_stmt "OutPC-Full" [] 
          "R[][A:float,B:float] := QR[][A:float,B:float]" 
          "R" 
          ("{|(1.0,1.0,1.0);(3.0,2.0,3.0);(2.0,1.0,9.0);(2.0,3.0,1.0);"^
             "(1.0,3.0,2.0)|}");
    ];
    group "Update" [
      test_stmt "SingletonPC-Singleton" [] "QS[][] += {12.}" "QS" "{|17.0|}";
      test_stmt "OutPC-Singleton-Update" ["A","1.0";"B","1.0"] 
          "R[][A,B] += {12.}" 
          "R" 
          ("{|(1.0,1.0,13.0);(1.0,2.0,2.0);(2.0,1.0,2.0);(2.0,2.0,4.0);"^
             "(1.0,3.0,3.0)|}");
      test_stmt ~dump:true "OutPC-Singleton-Insert" ["A","3.0";"B","3.0"] 
          "R[][A,B] += {12.}" 
          "R" 
          ("{|(1.0,1.0,1.0);(1.0,2.0,2.0);(2.0,1.0,2.0);(2.0,2.0,4.0);"^
             "(1.0,3.0,3.0);(3.0,3.0,12.0)|}");
      ...
      test_stmt "OutPC-Slice2" ["A","1.0"] 
          "R[][A,B] += ((B ^= 1.) * {12.}) + ((B ^= 2.) * {3.})" 
          "R" 
          ("{|(1.0,1.0,13.0);(1.0,2.0,5.0);(2.0,1.0,2.0);(2.0,2.0,4.0);"^
             "(1.0,3.0,3.0)|}");
      test_stmt "OutPC-Full" [] 
          "R[][A:float,B:float] += QR[][A:float,B:float]" 
          "R" 
          ("{|(1.0,1.0,2.0);(1.0,2.0,2.0);(1.0,3.0,5.0);
              (2.0,1.0,11.0);(2.0,2.0,4.0);(2.0,3.0,1.0);"^
             "(3.0,2.0,3.0)|}");
    ];
  ];
];;