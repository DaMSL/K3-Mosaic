      ...
      let expr = begin match ins, outs with
        ...
        | ([], y) ->
            ...
            if free_vars_k = [] then
               ...
               then mk_lookup map_expr (KT.base_of map_ret_kt ()) outs_k outs_tl
                  ...
                  let _,init_expr = unwrap_some init_expr_opt in
        ...
        | ( x, y) ->
            ...
            if init_expr_opt = None then
               ...
               let init_outs_el,ie = unwrap_some init_expr_opt in
...
let csv_adaptor_to_k3 (name_prefix: string)
  ...
  in
    ( (K.Sink(K.Code(
      ...
      K.TValue(KH.value_type_of_arg (lambda_args args))
    )
;;
