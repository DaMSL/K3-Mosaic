...
val decompose_delete_all_prefix : expr_t -> expr_t * expr_t
...
val decompose_pop : expr_t -> expr_t
...
val add_dproperty : string -> declaration_t * annotation_t -> declaration_t * annotation_t
