...
%token EQUIJOIN EXTEND INSERT INSERT_AT SET_ALL UPDATE DELETE DELETE_AT DELETE_WITH CLEAR_ALL UPDATE_AT_WITH UPSERT_WITH UPSERT_WITH_BEFORE UPDATE_SUFFIX DELETE_PREFIX FILTERGEQ FILTERLT FILTERLEQ FILTERGT
