...
let peers_num_update_code num_add = 
  ...
  mk_block [
    mk_delete peers_num_var old_num_var;
    mk_insert peers_num_var @: mk_add (mk_cint num_add) old_num_var
  ]
...
let peers_id_type = 
  [peers_id_type_addr_name, t_addr; peers_id_type_name_name, wrap_tmaybe t_string]
