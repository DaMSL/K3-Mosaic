...
let sw_send_do_trig_fn c t =
  ...
  let rcv_do_trig_nm = rcv_do_trig_name_of_t t in
...
let sw_rcv_do_trig c s_rhs_lhs s_rhs t =
  let send_puts =
                   ...
                   [
                    ...
                    mk_sendi nd_trig_dispatcher_trig_nm (mk_var "ip")
                      [mk_at' "vector_clock" @@ mk_var "ip"; mk_tuple
                         [mk_var D.me_int.id; mk_var "vid"; mk_var "pq"]]
                   ]
                 ) @@
              D.poly_queue_bitmap.id;
...
let gen_dist_for_t c ast t =
  ...
  let functions =
   ...
   (sw_rcv_do_trig c s_rhs_lhs s_rhs t) ::
