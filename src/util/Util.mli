...
val list_unzip3 : ('a * 'b * 'c) list -> ('a list * 'b list * 'c list)

(* fold up to last element, which is applied f_zero treatment *)
val list_fold_to_last : ('acc -> 'a -> 'acc) -> ('a -> 'acc) -> 'a list -> 'acc
