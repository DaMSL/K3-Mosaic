  ...
  let send_fetches_of_rhs_maps  =
    (mk_iter
      ...
      (mk_groupbyaggregate
        ...
        (mk_empty (BaseT(TCollection(TList, BaseT(TTuple([BaseT(TInt);BaseT(TInt)])))))) 
        (* [] *)
        (List.fold_left
        ...
        (List.fold_left
          (fun acc_code (stmt_id, ((rhs_map_id:map_id_t), (lhs_map_id:map_id_t))) ->
            ...
            (mk_combine
              ...
              (mk_map
                (mk_lambda
                  (ATuple(["ip", BaseT(TInt); 
                    "tuples", BaseT(TTuple(lhs_map_types))])
                  )
                  (mk_tuple
                ...
                (mk_apply
                  ...
                  (mk_tuple 
                    (key@
                      [mk_empty 
                        (BaseT(TCollection(TList,
                          BaseT(TTuple(rhs_map_types)))))
                      ]@
                      [mk_const (CBool(true))]
                    )
                  ) (* mk_tuple *)
        ...
        [] (* locals *),
          (mk_iter
            ...
            (mk_apply
              (mk_var shuffle_fn)
              (mk_tuple
                (rkey@(mk_slice rhs_map_id rkey)@[mk_const CBool(false)])
              )
            )
          ) (* mk_iter *)
        )
